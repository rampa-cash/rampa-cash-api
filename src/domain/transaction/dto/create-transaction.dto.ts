...
export class CreateTransactionDto {
    ...
    @ApiPropertyOptional({
        description:
            'External recipient wallet address (for external transfers)',
    ...
    @ApiPropertyOptional({
        description:
            'Memo for blockchain transaction (external transfers only)',
    ...
    @ApiPropertyOptional({
        description:
            "Sender wallet address override (optional - uses authenticated user's wallet if not provided)",
