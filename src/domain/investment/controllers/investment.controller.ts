...
export class InvestmentController {
    ...
    async getInvestmentOptionsByRisk(
        @Param('riskLevel') riskLevel: InvestmentRisk,
    ): Promise<InvestmentOption[]> {
    ...
    async searchInvestmentOptions(
        @Query() searchDto: SearchInvestmentDto,
    ): Promise<InvestmentOption[]> {
    ...
    async getUserInvestmentById(
        ...
        const investment = await this.investmentService.getUserInvestmentById(
            sessionUser.id,
            id,
        );
        if (!investment) {
    ...
    async getUserInvestmentPerformance(
        ...
        return this.investmentService.getUserInvestmentPerformance(
            sessionUser.id,
        );
    }
    ...
    async getInvestmentOptionPerformance(
        @Param('id') id: string,
    ): Promise<any> {
