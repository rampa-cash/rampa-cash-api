...
export class InitialSchema1762904926402 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TYPE "public"."wallet_wallet_type_enum" AS ENUM('para', 'phantom', 'solflare')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."wallet_status_enum" AS ENUM('active', 'suspended', 'deleted')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."user_auth_provider_enum" AS ENUM('para', 'google', 'apple', 'email', 'phone')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."investment_options_type_enum" AS ENUM('tokenized_asset', 'tokenized_etf', 'crypto_fund', 'staking_pool')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."investment_options_risklevel_enum" AS ENUM('low', 'medium', 'high', 'very_high')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."investment_options_status_enum" AS ENUM('active', 'inactive', 'suspended', 'maintenance')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE INDEX "IDX_4beeebf77d7df8162ea3a57870" ON "investment_options" ("isActive", "status") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_572be7c5e47768f125366d1466" ON "investment_options" ("riskLevel", "status") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_3b7afd49c7e9d20de867ae7c83" ON "investment_options" ("type", "status") `,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."onramp_transactions_tokentype_enum" AS ENUM('USDC', 'EURC', 'SOL')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."onramp_transactions_status_enum" AS ENUM('pending', 'processing', 'completed', 'failed', 'cancelled')`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."onramp_transactions_provider_enum" AS ENUM('transak', 'moonpay', 'ramp', 'wyre')`,
        );
        await queryRunner.query(
            `CREATE TABLE "onramp_transactions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "walletId" uuid NOT NULL, "amount" numeric(18,8) NOT NULL DEFAULT '0', "currency" character varying(3) NOT NULL, "tokenType" "public"."onramp_transactions_tokentype_enum" NOT NULL, "tokenAmount" numeric(18,8) NOT NULL DEFAULT '0', "status" "public"."onramp_transactions_status_enum" NOT NULL DEFAULT 'pending', "provider" "public"."onramp_transactions_provider_enum" NOT NULL, "providerTransactionId" character varying, "providerOrderId" character varying, "providerPaymentUrl" character varying, "fee" numeric(18,8) NOT NULL DEFAULT '0', "exchangeRate" numeric(18,8) NOT NULL DEFAULT '0', "failureReason" character varying, "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "completedAt" TIMESTAMP, "failedAt" TIMESTAMP, CONSTRAINT "PK_a47f594755e46cc2a8e0f69fa6d" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_0c62b293d87a530dc336c13c31" ON "onramp_transactions" ("provider", "status") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_943933e4ec107c6d3239a1080a" ON "onramp_transactions" ("userId", "createdAt") `,
        );
        await queryRunner.query(
            `CREATE INDEX "IDX_4ca9bc57099fae550b9ff14e0a" ON "onramp_transactions" ("userId", "status") `,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "bonk_rewards" ADD CONSTRAINT "FK_18e1a1d4c11de05f2790bab0a44" FOREIGN KEY ("module_id") REFERENCES "learning_modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "learning_progress" ADD CONSTRAINT "FK_a7a4a9f6e0a7642c9a562e8a4aa" FOREIGN KEY ("module_id") REFERENCES "learning_modules"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "offramp_transactions" ADD CONSTRAINT "FK_8ddd851ff7543cd1b5d00093036" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "offramp_transactions" ADD CONSTRAINT "FK_efadf505ecf6efbb7a27db5a2e7" FOREIGN KEY ("wallet_id") REFERENCES "wallet"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "onramp_transactions" ADD CONSTRAINT "FK_f1d6fdea67307e1c18b432a69cd" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "onramp_transactions" ADD CONSTRAINT "FK_057098c244f418c29a53ecaf069" FOREIGN KEY ("walletId") REFERENCES "wallet"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "user_investments" ADD CONSTRAINT "FK_a1f5e66e4cf0eee1e05965b04be" FOREIGN KEY ("investmentOptionId") REFERENCES "investment_options"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "investment_transactions" ADD CONSTRAINT "FK_5b8b106452b5ff9b94cbc26bbbe" FOREIGN KEY ("userInvestmentId") REFERENCES "user_investments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "investment_transactions" DROP CONSTRAINT "FK_5b8b106452b5ff9b94cbc26bbbe"`,
        );
        await queryRunner.query(
            `ALTER TABLE "user_investments" DROP CONSTRAINT "FK_a1f5e66e4cf0eee1e05965b04be"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "onramp_transactions" DROP CONSTRAINT "FK_057098c244f418c29a53ecaf069"`,
        );
        await queryRunner.query(
            `ALTER TABLE "onramp_transactions" DROP CONSTRAINT "FK_f1d6fdea67307e1c18b432a69cd"`,
        );
        await queryRunner.query(
            `ALTER TABLE "visa_card" DROP CONSTRAINT "FK_f56766ea30deb580b7fee67eb55"`,
        );
        await queryRunner.query(
            `ALTER TABLE "offramp_transactions" DROP CONSTRAINT "FK_efadf505ecf6efbb7a27db5a2e7"`,
        );
        await queryRunner.query(
            `ALTER TABLE "offramp_transactions" DROP CONSTRAINT "FK_8ddd851ff7543cd1b5d00093036"`,
        );
        await queryRunner.query(
            `ALTER TABLE "learning_progress" DROP CONSTRAINT "FK_a7a4a9f6e0a7642c9a562e8a4aa"`,
        );
        await queryRunner.query(
            `ALTER TABLE "bonk_rewards" DROP CONSTRAINT "FK_18e1a1d4c11de05f2790bab0a44"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `DROP INDEX "public"."IDX_e8e72edabdd8b85440451279a9"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_bb8ff27ac11792e5537c09f1ba"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_288d5109c1f241b389e0c37cc0"`,
        );
        await queryRunner.query(`DROP TABLE "investment_transactions"`);
        await queryRunner.query(
            `DROP TYPE "public"."investment_transactions_status_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."investment_transactions_type_enum"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_8d781263834af2774da137b7ac"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_4679aec30179700976430a614f"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_db6f6dcc388ad5adc59e0057d1"`,
        );
        await queryRunner.query(`DROP TABLE "user_investments"`);
        await queryRunner.query(
            `DROP TYPE "public"."user_investments_status_enum"`,
        );
        await queryRunner.query(`DROP TABLE "contact"`);
        await queryRunner.query(
            `DROP INDEX "public"."IDX_4ca9bc57099fae550b9ff14e0a"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_943933e4ec107c6d3239a1080a"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_0c62b293d87a530dc336c13c31"`,
        );
        await queryRunner.query(`DROP TABLE "onramp_transactions"`);
        await queryRunner.query(
            `DROP TYPE "public"."onramp_transactions_provider_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."onramp_transactions_status_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."onramp_transactions_tokentype_enum"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_3b7afd49c7e9d20de867ae7c83"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_572be7c5e47768f125366d1466"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_4beeebf77d7df8162ea3a57870"`,
        );
        await queryRunner.query(`DROP TABLE "investment_options"`);
        await queryRunner.query(
            `DROP TYPE "public"."investment_options_status_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."investment_options_risklevel_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."investment_options_type_enum"`,
        );
        ...
        await queryRunner.query(
            `DROP TYPE "public"."learning_modules_difficulty_enum"`,
        );
        await queryRunner.query(
            `DROP TYPE "public"."learning_modules_category_enum"`,
        );
        await queryRunner.query(`DROP TABLE "bonk_rewards"`);
        await queryRunner.query(
            `DROP TYPE "public"."bonk_rewards_status_enum"`,
        );
